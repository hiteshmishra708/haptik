...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CountriesSupported.format'
        db.delete_column('api_countries_supported', 'format')

        # Adding field 'CountriesSupported.numberformat'
        db.add_column('api_countries_supported', 'numberformat',
                      self.gf('django.db.models.fields.CharField')(default='XXX', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CountriesSupported.format'
        db.add_column('api_countries_supported', 'format',
                      self.gf('django.db.models.fields.CharField')(default='XXX', max_length=20),
                      keep_default=False)

        # Deleting field 'CountriesSupported.numberformat'
        db.delete_column('api_countries_supported', 'numberformat')
