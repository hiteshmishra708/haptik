...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CountriedSupported'
        db.delete_table('api_countries_supported')

        # Adding model 'CountriesSupported'
        db.create_table('api_countries_supported', (
            ...
            ('callcode', self.gf('django.db.models.fields.IntegerField')()),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['CountriesSupported'])


    def backwards(self, orm):
        # Adding model 'CountriedSupported'
        db.create_table('api_countries_supported', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ...
        db.send_create_signal('api', ['CountriedSupported'])

        # Deleting model 'CountriesSupported'
        db.delete_table('api_countries_supported')
