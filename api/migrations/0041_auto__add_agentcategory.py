...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgentCategory'
        db.create_table('api_agent_category', (
        ...
        db.send_create_signal('api', ['AgentCategory'])


    def backwards(self, orm):
        # Deleting model 'AgentCategory'
        db.delete_table('api_agent_category')
