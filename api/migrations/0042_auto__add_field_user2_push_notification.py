...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User2.push_notification'
        db.add_column('api_user_2', 'push_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User2.push_notification'
        db.delete_column('api_user_2', 'push_notification')


    models = {
        'api.agentcategory': {
            'Meta': {'object_name': 'AgentCategory', 'db_table': "'api_agent_category'"},
        ...
        'api.user2': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
            'push_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'unread': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
