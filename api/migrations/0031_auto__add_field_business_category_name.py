...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('api_business', 'category_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('api_business', 'category_name_id')
    ...
    models = {
        ...
        'api.business': {
            ...
            'category_name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['api.Category']", 'null': 'True'}),
