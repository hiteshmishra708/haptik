...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgentReviews'
        db.create_table('api_agent_reviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agent_id', self.gf('django.db.models.fields.IntegerField')()),
            ('review', self.gf('django.db.models.fields.TextField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['AgentReviews'])

        # Adding model 'Agents'
        db.create_table('api_agents', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('ratings', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('online', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['Agents'])


    def backwards(self, orm):
        # Deleting model 'AgentReviews'
        db.delete_table('api_agent_reviews')

        # Deleting model 'Agents'
        db.delete_table('api_agents')
