...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.haptik_flag'
        db.add_column('api_business', 'haptik_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Business.devicehelp_flag'
        db.add_column('api_business', 'devicehelp_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.haptik_flag'
        db.delete_column('api_business', 'haptik_flag')

        # Deleting field 'Business.devicehelp_flag'
        db.delete_column('api_business', 'devicehelp_flag')
