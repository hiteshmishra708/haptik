...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User2.unread'
        db.add_column('api_user_2', 'unread',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Business.unread'
        db.add_column('api_business', 'unread',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User2.unread'
        db.delete_column('api_user_2', 'unread')

        # Deleting field 'Business.unread'
        db.delete_column('api_business', 'unread')
