...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User2.device_token'
        db.add_column('api_user_2', 'device_token',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding field 'User2.device_platform'
        db.add_column('api_user_2', 'device_platform',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User2.device_token'
        db.delete_column('api_user_2', 'device_token')

        # Deleting field 'User2.device_platform'
        db.delete_column('api_user_2', 'device_platform')
    ...
    models = {
        ...
        'api.user2': {
            ...
            'coll_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'device_platform': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'device_token': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'}),
