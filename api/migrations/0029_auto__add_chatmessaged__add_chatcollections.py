...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChatMessaged'
        db.create_table(u'api_chatmessaged', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coll_id', self.gf('django.db.models.fields.IntegerField')()),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('direction', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['ChatMessaged'])

        # Adding model 'ChatCollections'
        db.create_table(u'api_chatcollections', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')()),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('from_user', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['ChatCollections'])


    def backwards(self, orm):
        # Deleting model 'ChatMessaged'
        db.delete_table(u'api_chatmessaged')

        # Deleting model 'ChatCollections'
        db.delete_table(u'api_chatcollections')
