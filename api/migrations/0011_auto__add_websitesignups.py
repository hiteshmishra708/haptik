...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WebsiteSignups'
        db.create_table('api_website_singups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('country_code', self.gf('django.db.models.fields.CharField')(default='91', max_length=250)),
            ('text_sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('downloaded', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['WebsiteSignups'])


    def backwards(self, orm):
        # Deleting model 'WebsiteSignups'
        db.delete_table('api_website_singups')
