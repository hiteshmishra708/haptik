...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_smslog', (
            ...
            ('sms_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('sms_sid', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('sent_successfully', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['SMSLog'])


    def backwards(self, orm):
        # Deleting model 'SMSLog'
        db.delete_table('api_smslog')
