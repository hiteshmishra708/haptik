...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.devicehelp_active'
        db.add_column('api_business', 'devicehelp_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.devicehelp_active'
        db.delete_column('api_business', 'devicehelp_active')
