...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.device_help_user'
        db.add_column('api_user', 'device_help_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.device_help_user'
        db.delete_column('api_user', 'device_help_user')
