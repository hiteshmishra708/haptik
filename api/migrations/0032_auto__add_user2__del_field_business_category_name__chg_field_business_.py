...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_user_2', (
            ...
            ('login_method', self.gf('django.db.models.fields.IntegerField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['User2'])

        # Deleting field 'Business.category_name'
        #db.delete_column(u'api_business', 'category_name_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('api_user_2')

        # Adding field 'Business.category_name'
        db.add_column(u'api_business', 'category_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Category'], null=True),
                      keep_default=False)


        # Changing field 'Business.category'
        db.alter_column('api_business', 'category', self.gf('django.db.models.fields.CharField')(max_length=250))
