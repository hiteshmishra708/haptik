...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.chat_notifications_allowed'
        db.add_column('api_user', 'chat_notifications_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.fav_notifications_allowed'
        db.add_column('api_user', 'fav_notifications_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.chat_notifications_allowed'
        db.delete_column('api_user', 'chat_notifications_allowed')

        # Deleting field 'User.fav_notifications_allowed'
        db.delete_column('api_user', 'fav_notifications_allowed')
