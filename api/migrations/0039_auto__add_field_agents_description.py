...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agents.description'
        db.add_column('api_agents', 'description',
                      self.gf('django.db.models.fields.TextField')(default='Batman is the secret identity of Bruce Wayne, an American billionaire, industrialist, and philanthropist.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agents.description'
        db.delete_column('api_agents', 'description')
