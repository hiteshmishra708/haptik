...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Business.phone_number'
        db.alter_column('api_business', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Business.email'
        db.alter_column('api_business', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=250))

        # Changing field 'Business.website'
        db.alter_column('api_business', 'website', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Business.phone_number'
        db.alter_column('api_business', 'phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
