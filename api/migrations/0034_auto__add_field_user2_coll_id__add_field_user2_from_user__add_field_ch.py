...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User2.coll_id'
        db.add_column('api_user_2', 'coll_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'User2.from_user'
        db.add_column('api_user_2', 'from_user',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ChatCollections.unread'
        db.add_column('api_chatcollections', 'unread',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User2.coll_id'
        db.delete_column('api_user_2', 'coll_id')

        # Deleting field 'User2.from_user'
        db.delete_column('api_user_2', 'from_user')

        # Deleting field 'ChatCollections.unread'
        db.delete_column('api_chatcollections', 'unread')
