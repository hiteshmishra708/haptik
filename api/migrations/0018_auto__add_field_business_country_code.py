...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.country_code'
        db.add_column('api_business', 'country_code',
                      self.gf('django.db.models.fields.CharField')(default='IN', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.country_code'
        db.delete_column('api_business', 'country_code')
