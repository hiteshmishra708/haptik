...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AkoshaBusiness'
        db.create_table('api_akoshabusiness', (
        ...
        db.send_create_signal('api', ['AkoshaBusiness'])


    def backwards(self, orm):
        # Deleting model 'AkoshaBusiness'
        db.delete_table('api_akoshabusiness')
