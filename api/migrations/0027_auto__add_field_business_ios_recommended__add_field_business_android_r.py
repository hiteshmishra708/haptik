...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.ios_recommended'
        db.add_column('api_business', 'ios_recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Business.android_recommended'
        db.add_column('api_business', 'android_recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Business.preview_text'
        db.add_column('api_business', 'preview_text',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.ios_recommended'
        db.delete_column('api_business', 'ios_recommended')

        # Deleting field 'Business.android_recommended'
        db.delete_column('api_business', 'android_recommended')

        # Deleting field 'Business.preview_text'
        db.delete_column('api_business', 'preview_text')
