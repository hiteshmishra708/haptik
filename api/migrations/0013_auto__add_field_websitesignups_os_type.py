...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebsiteSignups.os_type'
        db.add_column('api_website_singups', 'os_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebsiteSignups.os_type'
        db.delete_column('api_website_singups', 'os_type')
