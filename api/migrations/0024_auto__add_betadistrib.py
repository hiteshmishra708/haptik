...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BetaDistrib'
        db.create_table('api_beta_distrib', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('hex_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['BetaDistrib'])


    def backwards(self, orm):
        # Deleting model 'BetaDistrib'
        db.delete_table('api_beta_distrib')
