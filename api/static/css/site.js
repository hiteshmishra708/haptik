...
function sendNo() {
	...
	$.ajax({
		url : "http://54.244.118.146/api/v1/website_signup/?format=json",
		type : "POST",
		headers : {
		...
		success : function(response) {
			...
			$("p#checkQuestion").html("We have sent an SMS with further details to your number. Please share with your friends to make their lives easier too.<br><br> Click anywhere outside this box to close it.");
		},
		error : function(error) {
			...
			$("p#checkQuestion").html("To download the app again, visit haptik.co/download on your mobile device. And please do share it with your friends to make their lives easier.<br><br> Click anywhere outside this box to close it.");
...
function setBlog(data){
	...
	$("img#postImage").attr("src",$(postHTML).find('img:first').attr("src"));
...
function vai_a(id, v)
{
    ...
    $('html,body').animate({ scrollTop: $("#" + id).offset().top - 96 }, 600);
}
